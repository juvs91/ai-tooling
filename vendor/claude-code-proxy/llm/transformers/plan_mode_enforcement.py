...
_PLAN_MODE_EXIT_NOTE = (
    ...
    "Explora y lee archivos. "
    "Escribe el plan completo en el archivo que CC especificó en el system message "
    "(busca 'You should create your plan at' o 'A plan file already exists at' en el contexto). "
